...
WPMediaUtils.advertiseImageOptimization(this, mSite,new WPMediaUtils.OnAdvertiseImageOptimizationListener() {
public void done() {
fetchMedia(imageUri);
...
addMedia(downloadedUri);//buggy code
...
Error description:line 27-48, inappropriate code implementation
